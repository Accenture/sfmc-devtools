 ...
 * @property {string[]} unremovedEmptyDirs directories that hold no files (possibly only empty subdirectories) but the OS did not allow removing
 * @property {string[]} unremovedNonEmptyDirs directories that still hold files and must not be deleted
 */
/**
...
export type AssetV10MigrationReport = {
    ...
    /**
     * directories that hold no files (possibly only empty subdirectories) but the OS did not allow removing
     */
    unremovedEmptyDirs: string[];
    /**
     * directories that still hold files and must not be deleted
     */
