...
export default class ReplaceContentBlockReference {
     ...
     */
    static #getAssetBy(from: ContentBlockConversionTypes, identifier: string | number, parentName: string, isSsjs?: boolean, handleOutside?: boolean): AssetItemSimple;
    /**
     *
     ...
     * @returns {string} replaced string
     */
    static #replaceWith(asset: AssetItemSimple, to: ContentBlockConversionTypes, isSsjs?: boolean): string;
    /**
