...
declare class DataExtension extends MetadataType {
     ...
     */
    static "__#3@#filterUpsertResults"(res: object): boolean;
    /**
     ...
     * @returns {void}
     */
    static "__#3@#cleanupRetentionPolicyFields"(metadata: DataExtensionItem): void;
    /**
     ...
     * @returns {Promise.<void>} -
     */
    static "__#3@#fixShared"(upsertedMetadata: DataExtensionMap, originalMetadata: DataExtensionMap, createdUpdated: {
        created: number;
        updated: number;
    }): Promise<void>;
    /**
     ...
     */
    static "__#3@#fixShared_getBUs"(): Promise<string[]>;
    /**
     * helper for {@link DataExtension.#fixShared}
     *
     ...
     */
    static "__#3@#fixShared_onBU"(childBuName: string, buObjectParent: BuObject, clientParent: object, sharedDataExtensionMap: {
        [x: string]: string;
    }): Promise<string[]>;
    /**
     ...
     */
    static "__#3@#fixShared_item"(deId: string, deKey: string, buObjectChildBu: BuObject, clientChildBu: object, buObjectParent: BuObject, clientParent: object): Promise<boolean>;
    /**
     ...
     */
    static "__#3@#fixShared_item_addField"(buObjectChildBu: BuObject, clientChildBu: object, deKey: string, deId: string): Promise<string>;
    /**
     ...
     */
    static "__#3@#fixShared_item_getFieldId"(randomSuffix: string, buObjectParent: BuObject, clientParent: object, deKey: string): Promise<string>;
    /**
     ...
     * @returns {Promise} -
     */
    static "__#3@#fixShared_item_deleteField"(randomSuffix: string, buObjectChildBu: BuObject, clientChildBu: object, deKey: string, fieldObjectID: string): Promise<any>;
    /**
     ...
     * @returns {Promise.<void>} -
     */
    static "__#3@#attachFields"(metadata: DataExtensionMap, fieldOptions?: SoapRequestParams, additionalFields?: string[]): Promise<void>;
    /**
     * Retrieves dataExtension metadata. Afterwards starts retrieval of dataExtensionColumn metadata retrieval
     *
     * @param {string[]} [additionalFields] Returns specified fields even if their retrieve definition is not set to true
