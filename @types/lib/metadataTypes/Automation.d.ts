...
declare class Automation extends MetadataType {
     ...
     */
    static "__#2@#getAutomationNotificationsREST"(metadataMap: MetadataTypeMap): Promise<object>;
    /**
     * Retrieves Metadata of Automation
     *
     * @returns {Promise.<AutomationMapObj>} Promise of metadata
     ...
     */
    static "__#2@#isValidSchedule"(metadata: AutomationItem): boolean;
    /**
     ...
     */
    static "__#2@#executeItem"(metadataMap: AutomationMap, key: string): Promise<{
        key: string;
        response: object;
    }>;
    /**
     ...
     * @returns {Promise.<{key:string, response:object}>} metadata key and API response
     */
    static "__#2@#runOnce"(metadataEntry: AutomationItem): Promise<{
        key: string;
        response: object;
    }>;
    /**
     ...
     * @returns {Promise.<{key:string, response:object}>} metadata key and API response
     */
    static "__#2@#pauseItem"(metadata: AutomationItem): Promise<{
        key: string;
        response: object;
    }>;
    /**
     ...
     */
    static "__#2@#preDeploySchedule"(metadata: AutomationItem): void;
    /**
     ...
     * @returns {Promise.<void>} -
     */
    static "__#2@#updateNotificationInfoREST"(metadataMap: AutomationMap, key: string): Promise<void>;
    /**
     * helper for {@link Automation.postDeployTasks}
     *
     * @param {AutomationMap} metadataMap metadata mapped by their keyField
     ...
     * @returns {Promise.<{key:string, response:object}>} metadata key and API response
     */
    static "__#2@#scheduleAutomation"(metadataMap: AutomationMap, originalMetadataMap: AutomationMap, key: string, oldKey?: string): Promise<{
        key: string;
        response: object;
    }>;
    /**
     ...
     */
    static "__#2@#getObjectIdForSingleRetrieve"(key: string): Promise<string>;
    /**
