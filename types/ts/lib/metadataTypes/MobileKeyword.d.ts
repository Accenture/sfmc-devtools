...
declare class MobileKeyword extends MetadataType {
     ...
     */
    static "__#4@#createCustomKeyField"(metadata: MetadataTypeItem): void;
    /**
     ...
     * @param {MetadataTypeItem} metadata single item
     */
    static "__#4@#setCodeAndKeyword"(metadata: MetadataTypeItem): void;
    /**
     ...
     */
    static "__#4@#getRetrieveKeyAndUrl"(key: string): any[];
    /**
