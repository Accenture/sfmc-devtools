...
See [Migrating to v10](https://github.com/Accenture/sfmc-devtools/wiki/03.a-~-Migrating-to-v10) for tooling changes, replacement approvals, script migration and asset regrouping.
