...
class Init {
     ...
     */
    static async initGitRepo(skipInteraction) {
        ...
        const gitRepoFoundInCWD = await fs.pathExists('.git');
     ...
     * @returns {void}
     */
    static async gitPush(skipInteraction) {
     ...
     */
    static async _addGitRemote(skipInteraction) {
     ...
     * @returns {void}
     */
    static async _updateGitConfigUser(skipInteraction) {
     ...
     */
    static async _getGitConfigUser() {
