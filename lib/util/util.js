...
class Util {
     ...
     */
    static property() {
        this.authFileName = '.mcdev-auth.json';
        this.boilerplateDirectory = '../../boilerplate';
        this.configFileName = '.mcdevrc.json';
        this.parentBuName = '_ParentBU_';
        this.standardizedSplitChar = '/';
        /** @type {TYPE.skipInteraction} */
        this.skipInteraction = false;
        this.packageJsonMcdev = packageJsonMcdev;
        /** @type {TYPE.Logger} */
        this.loggerTransports = null;
        this.logger = null;
        this.restartLogger = startLogger;
    }
