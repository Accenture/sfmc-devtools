...
const Util = {
    ...
    checkProperties: async function (properties, silent) {
        ...
        // TODO Add check for credentials in auth store
                    ...
                    if (!silent && key === 'credentials') {
                        if (!Object.keys(properties.credentials)) {
                            ...
                            for (const cred in properties.credentials) {
                                ...
                                //         '--- update me ---'
                                // ) {
                                //     errorMsgs.push(`invalid client_secret on ${cred}`);
                                //     solutionSet.add(`Run 'mcdev init ${cred}'`);
                                // }
                                // TODO check against auth class to check this
                                // if (
