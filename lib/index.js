...
class Mcdev {
     ...
     * @param {SupportedMetadataTypes[] | TypeKeyCombo} [selectedTypesArr] limit retrieval to given metadata type
     ...
     * @param {SupportedMetadataTypes[] | TypeKeyCombo} [selectedTypesArr] limit retrieval to given metadata type/subtype
     * @param {string[]} [keys] limit retrieval to given metadata key
     * @param {boolean} [changelogOnly] skip saving, only create json in memory
     ...
     * @param {SupportedMetadataTypes} [selectedType] limit to given metadata types
     ...
     * @param {string} cred name of Credential
     * @param {string} bu name of BU
     * @param {SupportedMetadataTypes} [type] limit execution to given metadata type
     * @param {string[]} keyArr customerkey of the metadata
     ...
     *
     * @param {SupportedMetadataTypes} selectedType limit execution to given metadata type
