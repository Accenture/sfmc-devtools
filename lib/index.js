...
class Mcdev {
     ...
     * @param {string[]|TYPE.TypeKeyCombo} [selectedTypesArr] limit retrieval to given metadata type
     ...
     * @param {string[]|TYPE.TypeKeyCombo} [selectedTypesArr] limit retrieval to given metadata type/subtype
     * @param {string[]} [keys] limit retrieval to given metadata key
     * @param {boolean} [changelogOnly] skip saving, only create json in memory
