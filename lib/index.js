...
class Mcdev {
    ...
    static async _retrieveBU(cred, bu, selectedTypesArr, keys, changelogOnly) {
        ...
        if (buObject !== null) {
            ...
            if (selectedTypesArr) {
                for (const selectedType of selectedTypesArr) {
                    ...
                    if (!keys) {
                        ...
                        await fs.remove(File.normalizePath(removePathArr));
                    }
                }
            }
            if (!retrieveTypesArr.length) {
                ...
                fs.removeSync(File.normalizePath([properties.directories.retrieve, cred, bu]));
    ...
    static async badKeys(businessUnit) {
        ...
        if (buObject !== null) {
            ...
            if (await fs.pathExistsSync(filename)) {
