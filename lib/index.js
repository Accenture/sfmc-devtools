...
class Mcdev {
     ...
     * @param {string} businessUnit references credentials from properties.json
     * @param {string} selectedType supported metadata type
     * @param {string} key customerkey of the metadata
     * @param {string} market market localizations
     * @returns {Promise.<TYPE.MultiMetadataTypeList>} -
     */
    static async buildTemplate(businessUnit, selectedType, key, market) {
        Util.logger.info('mcdev:: Build Template from retrieve folder');
        return Builder.buildTemplate(businessUnit, selectedType, key, market);
    }
    /**
     * Build a specific metadata file based on a template.
     *
    ...
    static async buildDefinition(businessUnit, selectedType, name, market) {
        ...
        Builder.buildDefinition(businessUnit, selectedType, name, market);
    }
    ...
    static async buildDefinitionBulk(listName, type, name) {
        ...
        Builder.buildDefinitionBulk(listName, type, name);
    }
}
