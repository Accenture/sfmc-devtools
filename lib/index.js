...
class Mcdev {
     ...
     * @returns {Promise.<MultiMetadataTypeList>} response from buildDefinition
     */
    static async build(
        ...
        return this.buildDefinition(businessUnitDefinition, typeKeyCombo, null, marketDefinition);
    }
    /**
     * Build a template based on a list of metadata files in the retrieve folder.
     *
