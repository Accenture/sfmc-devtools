...
yargs
    ...
    .command({
        ...
        handler: (argv) => {
            ...
            Mcdev.deploy(
                argv.BU,
                argv.TYPE ? argv.TYPE.split(',') : null,
                argv.KEY ? argv.KEY.split(',') : null
            );
        },
    })
    .command({
    ...
    .command({
        ...
        desc: 'Converts classic E-Mails & classic Content Areas into the new Content Builder format',
        builder: (yargs) => {
            yargs.positional('BU', {
                type: 'string',
                describe: 'the business unit to deploy to',
