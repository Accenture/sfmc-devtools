...
class Folder extends MetadataType {
    ...
    static async create(metadata) {
        const { CustomerKey, Path } = metadata;
        ...
        if (metadata.Parent && metadata.Parent.ID && metadata.Parent.ID === 0) {
            ...
            try {
                const response = await sdk().soap.create('DataFolder', metadata, null);

                response.Results[0].Object = metadata;
                response.Results[0].Object.ID = response.Results[0].NewID;
                response.Results[0].Object.CustomerKey = CustomerKey;
    ...
    static async update(metadata) {
        ...
        try {
            const response = await sdk().soap.update('DataFolder', metadata, null);
            response.Results[0].Object = metadata;
            response.Results[0].Object.CustomerKey = CustomerKey;
            delete response.Results[0].Object.$;
