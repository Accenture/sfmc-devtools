...
class MetadataType {
     ...
     */
    static async postRetrieveTasksBulk(metadataMap) {
        // placeholder
    }
    /**
    ...
    static retrieveChangelog(buObject, additionalFields, subTypeArr) {
        return this.retrieveForCache(buObject, additionalFields, subTypeArr);
    }
    ...
    static async saveResults(results, retrieveDir, overrideType, templateVariables) {
        ...
        if (Object.keys(results).length) {
            await this.postRetrieveTasksBulk(results);
        }
