...
class MetadataType {
     ...
     * Gets metadata from Marketing Cloud
     *
     * @param {void} [_] unused parameter (buObject)
     * @param {string[]} [additionalFields] Returns specified fields even if their retrieve definition is not set to true
     * @param {string[]} [subTypeArr] optionally limit to a single subtype
     * @returns {Promise.<TYPE.MetadataTypeMapObj>} metadata
     */
    static retrieveChangelog(_, additionalFields, subTypeArr) {
    ...
    static async retrieveForCache(additionalFields, subTypeArr) {
        return this.retrieve(null, additionalFields, this.buObject, subTypeArr);
    }
    /**
     * Gets metadata cache with limited fields and does not store value to disk
     *
