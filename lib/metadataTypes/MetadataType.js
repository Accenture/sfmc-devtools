            ...
            if (hasError) {
                ...
                if (Util.OPTIONS.changeKeyField) {
                    if (
                        ...
                        Util.logger.info(
                            ` - Changing ${this.definition.type} key from ${
                                metadata[metadataKey][this.definition.keyField]
                            } to ${
                                metadata[metadataKey][Util.OPTIONS.changeKeyField]
                            } via --changeKeyField=${Util.OPTIONS.changeKeyField}`
                        );
                        metadata[metadataKey][this.definition.keyField] =
                            metadata[metadataKey][Util.OPTIONS.changeKeyField].trim();
                    ...
                    Util.logger.info(
                        ` - Changing ${this.definition.type} key from ${
                            metadata[metadataKey][this.definition.keyField]
                        }  to ${Util.OPTIONS.changeKeyValue} via --changeKeyValue`
                    );
                    metadata[metadataKey][this.definition.keyField] =
                        Util.OPTIONS.changeKeyValue.trim();
                }
                return 'update';
            }
        } else {
