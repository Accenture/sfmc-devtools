...
class MetadataType {
     ...
     */
    static retrieve(retrieveDir, additionalFields, subType) {
     ...
     * @returns {Promise<{metadata:Util.MetadataTypeMap,type:string}>} metadata
     */
    static retrieveChangelog(additionalFields, subType) {
     ...
     * @returns {Promise<{metadata:Util.MetadataTypeMap,type:string}>} metadata
     */
    static async retrieveForCache(subType) {
     ...
     */
    static async retrieveSOAP(retrieveDir, requestParams, additionalFields, overrideType) {
