...
class Asset extends MetadataType {
     ...
     */
    static async retrieve(retrieveDir, _, __, subTypeArr, key) {
        const items = [];
     ...
     *
     * @param {void} _ unused
     * @param {void} __ unused
     * @param {string[]} [subTypeArr] optionally limit to a single subtype
     * @returns {Promise.<{metadata: TYPE.AssetMap, type: string}>} Promise
     */
    static retrieveForCache(_, __, subTypeArr) {
        return this.retrieve(null, null, null, subTypeArr);
    }
