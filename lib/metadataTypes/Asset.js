        ...
        for (const key in metadataMap) {
            ...
            try {
                ...
                if (ex.code === 200) {
                    ...
                    // all good, we decide what to do about dependencies array down below based on findings by findLeafVals()
                } else {
                    Util.logger.error(
            ...
            if (dependentKeys.length > 0) {
                ...
                Util.logger.debug('Asset._getUpsertOrder: no dependent keys found');
