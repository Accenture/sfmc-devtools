...
class Asset extends MetadataType {
    ...
    static async retrieveAsTemplate(templateDir, name, templateVariables, selectedSubType) {
        this._enableShareAssetsIfNeeded();
    ...
    static async buildDefinition(templateDir, targetDir, templateName, variables) {
        this._enableShareAssetsIfNeeded();
        return super.buildDefinition(templateDir, targetDir, templateName, variables);
    }
     ...
     * @returns {void}
     */
    static _enableShareAssetsIfNeeded() {
        if (Util.OPTIONS.shareAssets) {
            this._enableShareAssets();
        }
    }
}
