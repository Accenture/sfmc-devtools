...
class Asset extends MetadataType {
     ...
     * @param {void} _ -
     * @param {AssetSubType[]} [subTypeArr] optionally limit to a single subtype
     ...
     * @private
     * @param {AssetItem} metadata a single asset
     * @returns {AssetSubType | void} subtype
     */
     ...
     * @param {string} templateDir Directory where metadata templates are stored
     * @param {string} templateName name of the metadata file
     * @returns {Promise.<AssetSubType>} subtype name
     */
     ...
     * @returns {Promise.<{key:string, name:string, path:string, mid:number}>} key, name and path of metadata; null if not found
     */
