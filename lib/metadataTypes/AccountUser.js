...
class AccountUser extends MetadataType {
     ...
     *
     * @param {TYPE.AccountUserDocumentMap} metadata metadata mapped by their keyField
     * @returns {Promise.<void>} promise
     */
    static async postDeployTasks(metadata) {
        await AccountUser._handleBuAssignments(metadata);
    }
    /**
    ...
    static async _handleBuAssignments(metadata) {
        ...
        /** @type {TYPE.AccountUserConfiguration[]} */
        const configs = [];
