...
class TransactionalMessage extends MetadataType {
    ...
    static async retrieve(retrieveDir, _, __, key) {
        ...
        if (retrieveDir) {
            ...
            if (!Object.keys(savedMetadata).length && key) {
    ...
    static deleteByKey(key) {
        return super.deleteByKeyREST('/messaging/v1/' + this.subType + '/definitions/' + key, key);
    }
}
...
TransactionalMessage.definition = MetadataTypeDefinitions.transactionalMessage;
TransactionalMessage.definition;
