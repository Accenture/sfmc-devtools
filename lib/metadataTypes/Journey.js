                    ...
                    for (
                        ...
                        try {
                            activityArguments.activityData.updateContactFields[
                                i
                            ].r__dataExtension_key = cache.searchForField(
                                'dataExtension',
                                contactField.dataExtensionId,
                                'ObjectID',
                                'CustomerKey'
                            );
                            delete activityArguments.activityData.updateContactFields[i]
                                .dataExtensionId;
                        } catch (ex) {
                            Util.logger.warn(
                                ` - ${this.definition.type} '${metadata[this.definition.nameField]}' (${
                        ...
                        try {
                            activityArguments.activityData.updateContactFields[i].field =
                                cache.searchForField(
                                    'dataExtensionField',
                                    contactField.field,
                                    'ObjectID',
