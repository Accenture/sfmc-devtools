        ...
        for (const activity of metadata.activities) {
            switch (activity.type) {
                ...
                case 'INAPPSYNCACTIVITY': {
                    ...
                    if (configurationArguments) {
                        // mobilePush
                        if (configurationArguments.r__mobilePush_key) {
                            configurationArguments.pushMessageId = cache.searchForField(
                                'mobilePush',
                        ...
                        if (configurationArguments.r__mobilePushApp_key) {
                            const mobilePushApp = cache.getByKey(
                                'mobilePushApp',
                            ...
                            if (mobilePushApp) {
                                ...
                                throw new Error(
                                    `mobilePushApp ${configurationArguments.r__mobilePushApp_key} not found in cache`
                                );
                            }
                        }
