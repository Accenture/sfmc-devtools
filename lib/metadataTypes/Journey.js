                    ...
                    for (const contactField of contactFields) {
                        ...
                        if (
                            ...
                            for (const field of fields) {
                                metadata[field.ObjectID] = field;
                            }
                            cache.setMetadata('dataExtensionField', metadata);
                            if (dataExtensionField) {
                                ...
                                Util.logger.warn(
                                    ` - ${this.definition.type} '${metadata[this.definition.nameField]}' (${
                                        metadata[this.definition.keyField]
                                    }) activity-key=${activity.key}: Dependent dataExtensionField with ObjectID ${contactField.field} was not found on your BU`
                                );
                            }
                        } else {
                            try {
