            ...
            switch (activity.type) {
                case 'EMAILV2': {
                    ...
                    if (triggeredSend) {
                        ...
                        try {
                            // content builder
                            triggeredSend.r__assetMessage_Name_readOnly = cache.searchForField(
                                'asset',
                                triggeredSend.emailId,
                                'legacyData.legacyId',
                                'name'
                            );
                            triggeredSend.r__assetMessage_Key = cache.searchForField(
                                'asset',
                                triggeredSend.emailId,
                                'legacyData.legacyId',
                                'customerKey'
            ...
            switch (activity.type) {
                case 'EMAILV2': {
                    ...
                    if (triggeredSend) {
                        ...
                        // email
                        if (triggeredSend.r__assetMessage_Key) {
                            triggeredSend.emailId = cache.searchForField(
                                'asset',
                                triggeredSend.r__assetMessage_Key,
                                'customerKey',
                                'legacyData.legacyId'
                            );
                            delete triggeredSend.r__assetMessage_Key;
                            delete triggeredSend.r__assetMessage_Name_readOnly;
