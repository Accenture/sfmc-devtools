            ...
            switch (activity.type) {
                ...
                case 'UPDATECONTACTDATA': {
                    ...
                    for (let i = 0; i < contactFields.length; i++) {
                        try {
                            contactFields[i].r__dataExtension_key = cache.searchForField(
                                'dataExtension',
                                contactFields.dataExtensionId,
                                'ObjectID',
                                'CustomerKey'
                            );
                            delete contactFields[i].dataExtensionId;
                        } catch (ex) {
                            Util.logger.warn(
                                ` - ${this.definition.type} '${metadata[this.definition.nameField]}' (${
                                    metadata[this.definition.keyField]
                        ...
                        try {
                            contactFields[i].field = cache.searchForField(
                                'dataExtensionField',
                                contactFields[i].field,
                                'ObjectID',
                                'Name'
                            );
                        } catch (ex) {
