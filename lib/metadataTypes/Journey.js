...
class Journey extends MetadataType {
    ...
    static async deleteByKey(key) {
        ...
        if (key.startsWith('id:') || key.startsWith('%23')) {
            ...
            cachedJourney = results[key];
            id = cachedJourney.id;
            Util.logger.debug(`Deleting interaction ${key} via its ID ${id}`);
        }
        switch (cachedJourney.definitionType) {
            ...
            default: {
                ...
                return super.deleteByKeyREST('/interaction/v1/interactions/' + id, key, false);
            }
        }
    }
