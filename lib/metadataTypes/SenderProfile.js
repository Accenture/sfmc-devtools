                    ...
                    if (domainVerification.status !== 'Verified') {
                        Util.logger.warn(
                            Util.getMsgPrefix(this.definition, metadata) +
                                `${field} ${email} is currently in status ${domainVerification.status}. This SenderProfile will not be usable in Journey Builder. To fix, please go to Setup > Feature Settings > Email Studio > From Address Management to verify the email.`
                        );
                    }
                    if (domainVerification.isSendable === false) {
                        Util.logger.warn(
                            Util.getMsgPrefix(this.definition, metadata) +
                                `${field} ${email} is currently not sendable. This SenderProfile will not be usable in Journey Builder. To fix, please go to Setup > Feature Settings > Email Studio > From Address Management to verify the email. You can also update this via mcdev`
                        );
                    }
                } else {
                    Util.logger.warn(
                        Util.getMsgPrefix(this.definition, metadata) +
                            `${field} ${email} is not verified. This SenderProfile will not be usable in Journey Builder. To fix, please go to Setup > Feature Settings > Email Studio > From Address Management to verify the email.`
                    );
                }
            }
        }
