export default {
    ...
    dependencyGraph: {
        dataExtract: ['metadata.steps[].activities[].r__key'],
        emailSend: ['metadata.steps[].activities[].r__key'],
        fileTransfer: ['metadata.steps[].activities[].r__key'],
        importFile: ['metadata.steps[].activities[].r__key'],
        query: ['metadata.steps[].activities[].r__key'],
        script: ['metadata.steps[].activities[].r__key'],
        verification: ['metadata.steps[].activities[].r__key'],
    },
