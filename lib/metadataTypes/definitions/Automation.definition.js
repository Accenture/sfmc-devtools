export default {
    ...
    dependencyGraph: {
        dataExtract: ['steps.activities.r__key'],
        emailSend: ['steps.activities.r__key'],
        fileTransfer: ['steps.activities.r__key'],
        importFile: ['steps.activities.r__key'],
        query: ['steps.activities.r__key'],
        script: ['steps.activities.r__key'],
        verification: ['steps.activities.r__key'],
    },
