export default {
    ...
    dependencyGraph: {
        ...
        attributeSet: [
            'metadata.relationships[].leftItem.identifier.r__attributeSet_key',
            'metadata.relationships[].rightItem.identifier.r__attributeSet_key',
        ],
        attributeGroup: [
            'metadata.relationships[].leftItem.identifier.r__attributeGroup_key',
            'metadata.relationships[].rightItem.identifier.r__attributeGroup_key',
        ],
    },
    hasExtended: false,
