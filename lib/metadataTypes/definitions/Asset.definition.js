...
export default {
    ...
    selflinkedSubTypes: ['asset', 'code', 'textfile', 'block', 'other', 'template', 'webstudio'],
    ...
    extendedSubTypes: {
        ...
        package: ['packagedefinition', 'packagedeployment'],
        audio: [
            'aac',
            'm4a',
            'au',
        ...
        email: ['templatebasedemail', 'htmlemail', 'textonlyemail', 'message'],
        mobile: ['jsonmessage'],
        other: [
            'smartcaptureblock',
        ...
        template: ['defaulttemplate', 'template', 'jsonmessagetemplate', 'jbtemplate'],
    ...
    typeMapping: {
        ...
        jsonmessage: 230, // sms message / whatsapp message based on 235
        jbtemplate: 231,
        icemailformblock: 232,
        iccloudpageblock: 233,
        einsteincontentselectionblock: 234,
        jsonmessagetemplate: 235, // whatsapp template
