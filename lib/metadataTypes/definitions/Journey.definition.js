...
export default {
    ...
    dependencies: [
        ...
        'mobilePush', // for PUSHINBOXACTIVITY and PUSHNOTIFICATIONACTIVITY and INAPPSYNCACTIVITY
        'mobilePushApp', // for PUSHINBOXACTIVITY and PUSHNOTIFICATIONACTIVITY and INAPPSYNCACTIVITY
        'asset-mobile', // for SMSSYNC-activity (sub-subtype jsonmessage)
        'list', // for EMAILV2-activity
        'email', // for EMAILV2-activity
        'asset-email', // for EMAILV2-activity
    ...
    dependencyGraph: {
        ...
        mobilePush: ['activities.configurationArguments.r__mobilePush_key'],
        mobilePushApp: ['activities.configurationArguments.r__mobilePushApp_key'],
    },
