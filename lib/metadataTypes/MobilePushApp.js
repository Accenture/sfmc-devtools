...
class MobilePushApp extends MetadataType {
    ...
    static retrieve(retrieveDir, _, __, key) {
        ...
        try {
            ...
            // if the MobilePushApp does not exist, the API returns the error "Request failed with status code 400 (ERR_BAD_REQUEST)" which would otherwise bring execution to a hold
