                    ...
                    for (const email of completionEmail) {
                        if (Util.emailValidator(email)) {
                            notificationBody.workers.push({
                                ...
                                definition: email,
                                body: completionNote ? completionNote : oldCompletionNote, // if new note is null then keep the old one only update emails
                                channelType: 'Account',
                            });
                        } else {
                            Util.logger.info(
                    ...
                    for (const email of errorEmail) {
                        if (Util.emailValidator(email)) {
                            notificationBody.workers.push({
                                ...
                                definition: email,
                                body: errorNote ? errorEmail : oldErrorNote,
                                channelType: 'Account',
                            });
                        } else {
                            Util.logger.info(
