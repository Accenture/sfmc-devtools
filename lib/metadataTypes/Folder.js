...
class Folder extends MetadataType {
     ...
     */
    static async retrieve(retrieveDir, additionalFields, buObject, subTypeArr, key) {
        if (key) {
     ...
     * @returns {Promise} Promise
     */
    static retrieveForCache(buObject, _, subTypeArr) {
        return this.retrieve(null, null, buObject, subTypeArr, null);
    }
