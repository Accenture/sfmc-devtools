...
class Folder extends MetadataType {
    ...
    constructor(properties, buObject) {
        ...
        this.definition = require('../MetadataTypeDefinitions').folder;
    }
    /**
     ...
     */
    async retrieveHelper(additionalFields, queryAllAccounts) {
     ...
     * @returns {Promise<Object>} Promise of saved metadata
     */
    async saveResults(results, retrieveDir, mid) {
        const savedResults = {};
