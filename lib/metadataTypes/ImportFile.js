...
class ImportFile extends MetadataType {
    ...
    static async preDeployTasks(metadata) {
        metadata.fileTransferLocationId = cache.search(
            this.buObject.mid,
            'ftpLocation',
        ...
        if (metadata.c__destinationType === 'DataExtension') {
            try {
                metadata.destinationObjectId = cache.search(
                    this.buObject.mid,
                    'dataExtension',
            ...
            try {
                metadata.destinationObjectId = cache.getListObjectIdFromCache(
                    this.buObject.mid,
    ...
    static parseMetadata(metadata) {
        metadata.r__ftpLocation_name = cache.search(
            this.buObject.mid,
            'ftpLocation',
        ...
        if (metadata.c__destinationType === 'DataExtension') {
            try {
                metadata.r__dataExtension_CustomerKey = cache.search(
                    this.buObject.mid,
                    'dataExtension',
