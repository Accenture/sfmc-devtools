...
class DataExtension extends MetadataType {
    ...
    static async retrieve(retrieveDir, additionalFields, _, key) {
        ...
        if (cache.getCache()?.filterDefinitionHidden) {
            const fdhMap = cache.getCache()?.filterDefinitionHidden;
            for (const key in fdhMap) {
                ...
                if (
                    ...
                    this.deIdfilterDefinitionMap[deObjectId] = item;
                }
            }
        }
    ...
    static async postRetrieveTasks(metadata) {
        ...
        if (this.deIdfilterDefinitionMap[metadata.ObjectID]) {
            metadata.r__filterDefinition_key = this.deIdfilterDefinitionMap[metadata.ObjectID].key;
        }
        return metadata;
    }
    ...
    static async preDeployTasks(metadata) {
        ...
        delete metadata.r__filterDefinition_key;
