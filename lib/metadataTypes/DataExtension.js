...
class DataExtension extends MetadataType {
     ...
     */
    static async retrieve(retrieveDir, additionalFields, _, isDeploy) {
     ...
     */
    static async document(metadata, isDeploy) {
        if (!metadata) {
     ...
     * @returns {Promise} Promise
     */
    static async retrieveForCache(_, isDeploy) {
