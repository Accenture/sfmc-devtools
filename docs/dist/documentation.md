...
<dt><a href="#ClassicMigration">ClassicMigration</a></dt>
<dd><p>Builds metadata from a template using market specific customisation</p>
</dd>
...
* [ClassicMigration](#ClassicMigration)
    * [new ClassicMigration(properties, buObject)](#new_ClassicMigration_new)
    * [.convert()](#ClassicMigration+convert) ⇒ <code>Promise</code>

<a name="new_ClassicMigration_new"></a>

### new ClassicMigration(properties, buObject)
...
<a name="ClassicMigration+convert"></a>

### classicMigration.convert() ⇒ <code>Promise</code>
...
**Kind**: instance method of [<code>ClassicMigration</code>](#ClassicMigration)  
...
* [Mcdev](#Mcdev)
    ...
    * [.convertClassic(businessUnit)](#Mcdev.convertClassic) ⇒ <code>Promise.&lt;void&gt;</code>
...
| --- | --- | --- |
| businessUnit | <code>string</code> | references credentials from properties.json |
| selectedType | <code>TYPE.SupportedMetadataTypes</code> | supported metadata type |
| name | <code>string</code> | name of the metadata |
...
<a name="Mcdev.convertClassic"></a>

### Mcdev.convertClassic(businessUnit) ⇒ <code>Promise.&lt;void&gt;</code>
handler for 'mcdev convertClassic'
...
| Param | Type | Description |
| --- | --- | --- |
| businessUnit | <code>string</code> | references credentials from .mcdevrc.json |
...
* [ContentArea](#ContentArea) ⇐ [<code>MetadataType</code>](#MetadataType)
    ...
    * [.preDeployTasks(metadata, dir)](#ContentArea.preDeployTasks) ⇒ <code>Promise</code>
    * [.convert(classicMetadata, nameSafe)](#ContentArea.convert) ⇒ <code>object</code>
...
<a name="ContentArea.preDeployTasks"></a>

### ContentArea.preDeployTasks(metadata, dir) ⇒ <code>Promise</code>
...
<a name="ContentArea.convert"></a>

### ContentArea.convert(classicMetadata, nameSafe) ⇒ <code>object</code>
takes one classic email and converts it into
a content builder based email

**Kind**: static method of [<code>ContentArea</code>](#ContentArea)  
**Returns**: <code>object</code> - asset-message-htmlemail  

| Param | Type | Description |
| --- | --- | --- |
| classicMetadata | <code>object</code> | classic email |
| nameSafe | <code>object</code> | ensure names are only used once (Content Builder requirement) |
...
* [Email](#Email) ⇐ [<code>MetadataType</code>](#MetadataType)
    ...
    * [.preDeployTasks(metadata, dir)](#Email.preDeployTasks) ⇒ <code>Promise</code>
    * [.convert(classicMetadata, nameSafe)](#Email.convert) ⇒ <code>object</code>
...
<a name="Email.preDeployTasks"></a>

### Email.preDeployTasks(metadata, dir) ⇒ <code>Promise</code>
prepares an email for deployment
...
<a name="Email.convert"></a>

### Email.convert(classicMetadata, nameSafe) ⇒ <code>object</code>
takes one classic email and converts it into
a content builder based email
